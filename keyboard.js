...
/* 										  console.log(leapPosition); */
										  if(leapPosition[1] >=59 && leapPosition[1] <=85){
											  rowStartIndex = 0;
											  rowEndIndex = 13;
										  }else if(leapPosition[1] >=86 && leapPosition[1] <=112){
											  rowStartIndex = 14;
											  rowEndIndex = 27;
										  }else if(leapPosition[1] >=113 && leapPosition[1] <=139){
											  rowStartIndex = 28;
											  rowEndIndex = 40;
										  }else if(leapPosition[1] >=140 && leapPosition[1] <=166){
											  rowStartIndex = 41;
											  rowEndIndex = 52;
										  }else{
											  rowStartIndex = 53;
										  ...
										  for(var j=rowStartIndex ;j<=rowEndIndex ;j++){
										  	  ...
										  	  bottom = keys.eq(j).position().top + 27 -1;
